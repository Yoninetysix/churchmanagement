...
<div class="top-bar">
        ...
        <div class="user-notifications">
            <div class="notifications">
                ...
                <span class="notification-count">38</span>
            </div>
...
<li><a href="approve_request.php"><i class="fas fa-certificate"></i> Certificates Requests</a></li>
<li><a href="view_service_req.php"><i class="fas fa-clipboard-list"></i> Service Requests</a></li>

<li><a href="view_property_management.php"><i class="fas fa-home"></i> Church Property Management</a></li>
<li><a href="view_property_management.php"><i class="fas fa-home"></i> Income and expenses Management</a></li>
...
<li><a href="login.php"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
    ...
    <div class="stats">
        <div class="stat-item">
            ...
            <div class="icon">
                <img src="path/to/pastor-icon.png" alt="Pastors Icon">
            </div>
        ...
        <div class="stat-item">
            ...
            <div class="icon">
                <img src="path/to/events-icon.png" alt="Events Icon">
            </div>
        ...
        <div class="stat-item">
            <div class="number">10</div>
            <div class="icon">
                <img src="path/to/groups-icon.png" alt="Groups Icon">
            </div>
        ...
        <div class="stat-item">
            <div class="number">10</div>
            <div class="icon">
                <img src="path/to/sunday-school-icon.png" alt="Sunday Schools Icon">
            </div>
